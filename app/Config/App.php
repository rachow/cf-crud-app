...
class App extends BaseConfig
{
     ...
     */
     ...
     // 13-06-2023 - $rachow - removing index.php, better URL and SEO friendly for sure!
     public $indexPage = '';
     ...
     */
     ...
     /**
     *  13-06-2023 $rachow - don't giveaway anything specifics ;).
     */
     public string $sessionCookieName = 'cfx_sess';
