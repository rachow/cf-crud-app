...
if(session()->has('validation')){
	$errors = session()->get('validation')->getErrors();
}
			...
			<div class="row">
			   <div class="card shadow mb-4 col-md-12">
				...
				<div class="col-md-12 mb-5">
					...
					<?php endif; ?>
					<p class="lead text-muted">Add a new user to the platform<p>
					...
					?>
					<form id="cf-frm-addusr" method="POST" action="/user/create" autocomplete="off" charset="utf-8">
						...
						<div class="form-group row">
							<div class="col-md-4">
								...
								<input type="text" name="username" id="cf-username" class="form-control" value="<?= old('username'); ?>">
						...
						<div class="form-group row">
							<div class="col-md-4">
								<label>E-mail*</label>
								<input type="email" name="email" id="cf-email" class="form-control" placeholder="Enter email" value="<?= old('email'); ?>">
						...
						<div class="form-group row">
							<div class="col-md-4">
								<label>Mobile</label>
								<input type="tel" name="mobile" class="form-control mobile-input" value="<?= old('mobile'); ?>">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
